"""
Django settings for learner_portal project.
...
SECRET_KEY = 'django-insecure-^mft3=ht-c!@o=x4(!_i3k#e$xl9&l)_ef@1p8=lxfe4^tv$!5'
...
ROOT_URLCONF = 'learner_portal.urls'



WSGI_APPLICATION = 'learner_portal.wsgi.application'
...
TEMPLATES = [
 ...
 # project-level templates folder
        'APP_DIRS': True,                  # allows app-level templates (like core/templates)
        'OPTIONS': {
            'context_processors': [
...
LOGIN_URL = 'login'              # where users are sent if not logged in
